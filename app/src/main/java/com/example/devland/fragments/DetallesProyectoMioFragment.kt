...
class DetallesProyectoMioFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_detalles_proyecto_mio, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //textViewUsuario.text = args.proyecto.propietario.nombre
    }
